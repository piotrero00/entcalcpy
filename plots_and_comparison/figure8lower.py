...
# Figure 8 uses approximately h in [-2, 2]
# step = 0.05
for hi in range(-200, 205, 5):
    ...
    print("h =", h, "lower =", lower[0])


# Save results
with open("figure8lower_beta5.txt", "w") as filehandle:
    for lis in resultsp:
