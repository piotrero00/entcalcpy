...
print(en.ge_mixed_ra_sm([ghz,w],[0.7,0.3],[2,2,2],solversdp="MOSEK"))
"""
...
"""
print(en.ge_mixed_ra_sm([ghz,w],[0.7,0.3],[2,2,2],itera=100,sdpaccuracy=10**(-5)))
"""
