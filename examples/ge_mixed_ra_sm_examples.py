...
"""
We demostrate different usage of parameters for ge_mixed_ra_sm.
Proper parametr usage influences performance of the functions.
This function takes probabilities and corresponding pure
states as input. Thanks to this, it is able to find
more efficient purification.
"""

print("Default values:",en.ge_mixed_ra_sm([ghz,w],[0.7,0.3],[2,2,2]))
"""
We found accurate solution. However, if we set too little number of iterations
we would not found a proper lower bound.
"""
print("itera=100:",en.ge_mixed_ra_sm([ghz,w],[0.7,0.3],[2,2,2],itera=100))
"""
We obtained result, which is accoriding to solver output is inaccurate.
Setting too little iteration causes that we might obtain result higher than lower bound. It is indicated by innacurate
string in the second position in the result.

"""

print("solversdp='MOSEK':",en.ge_mixed_ra_sm([ghz,w],[0.7,0.3],[2,2,2],solversdp="MOSEK"))
"""
...
"""
print("itera=100,sdpaccuracy=10**(-5):",en.ge_mixed_ra_sm([ghz,w],[0.7,0.3],[2,2,2],itera=100,sdpaccuracy=10**(-5)))
"""
