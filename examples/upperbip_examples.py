...
print("iteramax=1000 first try:",en.upperbip(rho,[4,2],iteramax=1000))
"""
...
"""
print("iteramax=1000 second try:",en.upperbip(rho,[4,2],iteramax=1000))
"""
We can control accuracy and time of computations, by iteramax, dif.
For qs, sqs see several_similar_states_for_upper_bound
"""

print("dif=10**(-5),iteramax=4500",en.upperbip(rho,[4,2],dif=10**(-5),iteramax=4500))
"""
...
early stop. 
"""
print("dif=10**(-9),iteramax=4500",en.upperbip(rho,[4,2],dif=10**(-9),iteramax=4500))
"""
