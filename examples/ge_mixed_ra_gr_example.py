...
print("================================================================")
print("  entcalcpy: ge_mixed_ra_gr usage and parameter tuning          ")
print("================================================================")
print("This script demonstrates how different parameters influence")
print("the performance and accuracy of the ge_mixed_ra_gr function.")
print("Unlike ge_mixed_gr, this function takes a list of pure states")
print("and their corresponding probabilities as input.\n")
...
res_default = en.ge_mixed_ra_gr(states, probs, dims)
...
res_itera = en.ge_mixed_ra_gr(states, probs, dims, itera=100)
...
try:
    ...
    res_mosek = en.ge_mixed_ra_gr(states, probs, dims, solversdp="MOSEK")
...
res_acc = en.ge_mixed_ra_gr(states, probs, dims, itera=100, sdpaccuracy=10**(-5))
