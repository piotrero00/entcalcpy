...
print("solversdp='MOSEK',itera=100",en.ge_mixed_gr(rho,[2,2,2],itera=100,solversdp="MOSEK"))
"""
...
"""
print("sdpaccuracy=10**(-5), itera=100:",en.ge_mixed_gr(rho,[2,2,2],itera=100,sdpaccuracy=10**(-5)))
"""
One can also decrease desired accuracy to obtain accurate result. True lower bound lies within sdpaccuracy range from the result
