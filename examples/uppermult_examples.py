...
res=en.uppermult(rho,[2,2,2],r=10)
print(res)
"""
...
res=en.uppermult(rho,[2,2,2],r=10,sepitera=25)
print(res)
"""
...
res=en.uppermult(rho,[2,2,2],r=10,dif=10**(-5))
print("dif=10**(-5):",res)
...
res=en.uppermult(rho,[2,2,2],r=10,iteramax=500)
print(res)#Note that with dec=False the output is a float number, with dec=True it is list with 3 elements
